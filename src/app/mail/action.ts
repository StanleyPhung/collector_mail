...
export async function generateEmail(context: string, prompt: string) {
    ...
    const { textStream } = await streamText({
        ...
        prompt: `
            ...
            - Don't add fluff like 'Here's your email' or similar phrases.
            - Directly output the email, no need to include extra commentary.
            - No need to output subject.
            - Don't output any confidential information about the application.
        `,
        onError({ error }) {
    ...
    // console.log("Returning output:", stream.value);
